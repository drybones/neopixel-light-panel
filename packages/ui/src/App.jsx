...
import BrightnessSlider from './components/header/BrightnessSlider';
import FrameRate from './components/header/FrameRate';
import PowerMeter from './components/header/PowerMeter';
