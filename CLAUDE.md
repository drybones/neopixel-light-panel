...
- `components/switcher/` — scene-card grid (mobile-friendly), brightness, export/import. The **active** card streams the live composite (it is the only scene the server renders); every other card plays its filmstrip.
